...
module.exports = function (router, check) {
    //注册
    router.post('/public/register', function (req, res) {
    ...
    //登录
    router.post('/public/login', check(["username", "password", "code"], function (req, res) {
    ...
    router.get('/public/casual1', check([], function (req, res) {
        res.result({
            data: [{
                "id": "10001",
                "username": "杜甫",
